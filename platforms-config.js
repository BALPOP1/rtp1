 ...
 * ============================
 * This file contains platform links that can be customized per website.
 * Each website should have its own copy of this file with unique affiliate links.
 * 
 * HOW TO USE:
 * 1. Copy this file to your website folder
 * 2. Update the URLs with YOUR affiliate links
...
const PLATFORMS_CONFIG = [
    { id: 19, url: 'https://00popzoe.com', name: 'EM BREVE' },
...
// The main script will check if PLATFORMS_CONFIG exists and use it
console.log('✅ Platforms config loaded:', PLATFORMS_CONFIG.length, 'platforms');
